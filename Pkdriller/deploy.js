...
✔First type the sc ,repo or script command and you will get Redmi-XMD repository 
✔From there you are required to get your *Session id* but how,??..
         𝐇𝐎𝐖 𝐓𝐎 𝐆𝐄𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐈𝐃
✞ Open this link 👉 https://redmixmd-301c0a9a5078.herokuapp.com then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  254759000340 then tap submit 
✞ Redmi-XMD owner , *Redmi-XMD* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that Redmi-XMD  owner sent you.
✞ After a successful login Redmi-XMD owner 😂 Redmi-XMD will send you a *session id* .some will wonder where the hell is that session ,,,...It is just right at your inbox /dm {your own number for whatsappp} 😂
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 𝙍𝙚𝙙𝙢𝙞-𝙓𝙈𝘿
✔ Now check on Redmi-XMD repository in github fork and give a star to this repository before doing anything 🌟or else Redmi-XMD owner won't allow you to deploy his bot💀.
...
✔Now click on this devs number and give Redmi-XMD owner credits https://wa.me/+254759000340
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 🅑r̸𝐢𝖌𝖍t̸_×͜×🌟`;
   var lien = mybotpic();
